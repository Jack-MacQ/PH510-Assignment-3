...
This implementation was written as a deterministic reference solver for comparison
with the random-walk method.
...
class PoissonSOR:
    ...
    def __post_init__(self) -> None:
        ...
        # Use a standard near-optimal SOR parameter for a square grid (unless it
